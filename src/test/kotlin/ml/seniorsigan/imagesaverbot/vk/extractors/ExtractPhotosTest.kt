...
class ExtractPhotosTest {
            ...
            "attachments": [
              {
                "photo": {
                  ...
                  "long": 73.375623,
                  "owner_id": 38057738,
                  "photo_1280": "https://pp.userapi.com/c846017/v846017600/1cc33/KWimXCetKKs.jpg",
    ...
    fun shouldExtractPhoto() {
        ...
        assertEquals("https://pp.userapi.com/c846017/v846017600/1cc33/KWimXCetKKs.jpg", photos.first().url)
    }
}